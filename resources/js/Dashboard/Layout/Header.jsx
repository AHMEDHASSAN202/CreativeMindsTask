                    ...
                    <div id="kt_header_menu" className="header-menu header-menu-mobile  header-menu-layout-default ">
                        ...
                        <ul className="menu-nav ">
                            ...
                            <li className="menu-item  menu-item-open menu-item-here menu-item-rel" aria-haspopup="true">
                                <InertiaLink href={'/dashboard/users'} className="menu-link menu-toggle">
                ...
                <div className="topbar">
                    ...
                    <div className="topbar-item">
                        <form method='post' action='/dashboard/logout'>
                            <input type='hidden' value={window.CSRF_TOKEN} name='_token'/>
                            <button
                                type='submit'
                            ...
                            >
                                ...
                                <span className="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3 text-capitalize">AHMED</span>
                                <span className="symbol symbol-lg-35 symbol-25 symbol-light-success">
		                        <span className="symbol-label font-size-h5 font-weight-bold text-uppercase">A</span>
		                    </span>
                            </button>
                        </form>
                    </div>
